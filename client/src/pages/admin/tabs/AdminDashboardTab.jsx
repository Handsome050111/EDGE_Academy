  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-7 shadow-xs flex flex-col space-y-5">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Learner completion rate and certification across learning tracks</p>
                        ...
                        <span className="text-xs font-semibold px-2.5 py-1 bg-slate-100 text-slate-700 rounded-full whitespace-nowrap">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-7 shadow-xs flex flex-col space-y-5">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Concepts with the lowest quiz accuracy across all engineers</p>
                                    ...
                                    <span className="text-xs font-semibold px-2.5 py-1 bg-amber-50 text-amber-800 border border-amber-200 rounded-full whitespace-nowrap">
          ...
          <div className="space-y-3">
            {weakConcepts.length === 0 ? (
              ...
              weakConcepts.slice(0, 5).map((item, idx) => {
